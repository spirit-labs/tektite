...
func (m *OffsetCommitResponse) Read(version int16, buff []byte) (int, error) {
    offset := 0
    ...
    }
    {
        ...
        if l0 >= 0 {
            ...
            topics := make([]OffsetCommitResponseOffsetCommitResponseTopic, l0)
            for i0 := 0; i0 < l0; i0++ {
                // reading non tagged fields
                {
                ...
                }
                {
                    ...
                    if l2 >= 0 {
                        // length will be -1 if field is null
                        partitions := make([]OffsetCommitResponseOffsetCommitResponsePartition, l2)
                        for i1 := 0; i1 < l2; i1++ {
                            // reading non tagged fields
                            {
...
func (m *OffsetCommitResponse) Write(version int16, buff []byte, tagSizes []int) []byte {
    var tagPos int
...
func (m *OffsetCommitResponse) CalcSize(version int16, tagSizes []int) (int, []int) {
    size := 0
