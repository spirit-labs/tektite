                ...
                if version >= 13 {
                    {
                        ...
                        topics[i0].TopicId = common.CopyByteSlice(buff[offset: offset + 16])
                        offset += 16
                    }
                }
                {
                                            ...
                                            if version >= 17 {
                                                {
                                                    ...
                                                    partitions[i1].ReplicaDirectoryId = common.CopyByteSlice(buff[offset: offset + 16])
                                                    offset += 16
                                                }
                                            } else {
                    ...
                    if version >= 13 {
                        {
                            ...
                            forgottenTopicsData[i2].TopicId = common.CopyByteSlice(buff[offset: offset + 16])
                            offset += 16
                        }
                    }
                    {
