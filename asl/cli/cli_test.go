...
func testCliFailure(t *testing.T, clientTLSConfig client.TLSConfig, serverTLSConfig conf.TLSConfig) {
...
func testCli(t *testing.T, clientTLSConfig client.TLSConfig, serverTLSConfig conf.TLSConfig) {
	serverAddress, err := common.AddressWithPort("localhost")
	require.NoError(t, err)
