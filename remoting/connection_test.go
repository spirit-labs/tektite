...
func testResponseError(t *testing.T, respErr error, checkFunc func(*testing.T, errors.TektiteError)) {
	t.Helper()
...
func TestCloseConnectionFromServer(t *testing.T) {
	...
	err = conn.QueueRequest(&clustermsgs.RemotingTestMessage{SomeField: "badgers"}, handler)
