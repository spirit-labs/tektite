...
func (m *HeartbeatResponse) Read(version int16, buff []byte) (int, error) {
    offset := 0
...
func (m *HeartbeatResponse) Write(version int16, buff []byte, tagSizes []int) []byte {
    var tagPos int
...
func (m *HeartbeatResponse) CalcSize(version int16, tagSizes []int) (int, []int) {
    size := 0
