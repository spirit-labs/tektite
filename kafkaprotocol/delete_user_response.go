...
func (m *DeleteUserResponse) Read(version int16, buff []byte) (int, error) {
    offset := 0
...
func (m *DeleteUserResponse) Write(version int16, buff []byte, tagSizes []int) []byte {
    var tagPos int
...
func (m *DeleteUserResponse) CalcSize(version int16, tagSizes []int) (int, []int) {
    size := 0
